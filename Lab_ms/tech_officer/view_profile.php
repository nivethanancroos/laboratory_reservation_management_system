...
<head>
    ...
    <style>
        ...
        .bg-dark-blue {
            background-color: #4e5d94; /* Darker shade of blue */
...
<body>
    ...
    <div class="container">
        <h1><i class="fas fa-eye"></i> View Profile</h1>
        <br>
        <br>
        <p><i class="fas fa-user"></i> Welcome, <?php echo $_SESSION['name']; ?>!!</p>
        <p><i class="fas fa-envelope"></i> Email: <?php echo $_SESSION['email']; ?></p>
        <br>
        <div class="row">
            <div class="col-md-6">
                <h3 class="bg-dark-blue">Profile Information</h3>
                <table class="table">
                    <tr>
                        <th>Name</th>
